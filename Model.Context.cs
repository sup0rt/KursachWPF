...
namespace WpfApp1
{
    ...
    public partial class Entities : DbContext
    {
        ...
        public virtual ObjectResult<GetPartInventory_Result> GetPartInventory(Nullable<int> partID)
        {
            var partIDParameter = partID.HasValue ?
                new ObjectParameter("PartID", partID) :
                new ObjectParameter("PartID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetPartInventory_Result>("GetPartInventory", partIDParameter);
        }
